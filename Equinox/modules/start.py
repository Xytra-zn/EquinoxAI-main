...
I’m your friendly AI companion, equipped with an array of exciting features.

Whether you need natural language understanding, image generation, or even text-to-speech capabilities, I’ve got you covered.
...
async def start(_, message):
    buttons = [
        ...
        [
          InlineKeyboardButton("๏sᴜᴘᴘᴏʀᴛ๏", url="https://t.me/ALLTYPECC"),
